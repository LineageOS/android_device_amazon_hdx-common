...
/******************************************************************************
 *
 *  Filename:      userial_vendor_ar3k.c
 *
...
#define BLUETOOTH_UART_DEVICE_PORT      "/dev/ttyHS0"    /* AR3002 */
...
extern int hw_config_ath3k(char *port_name);
/*****************************************************************************
**   Helper Functions
*****************************************************************************/
...
{   ALOGI("Enter userial_vendor_init");
    vnd_userial.fd = -1;
...
int userial_vendor_open(tUSERIAL_CFG *p_cfg)
{
    ...
    vnd_userial.fd = hw_config_ath3k(vnd_userial.port_name);
    if (vnd_userial.fd < 0) {
...
{
	if (sizeof(p_conf_value) <= sizeof(vnd_userial.port_name))
		strlcpy(vnd_userial.port_name, p_conf_value, sizeof(p_conf_value));
	else
		return -1;
