...
def createsig():
    ...
    f = open("/home/cpasjuste/android-cm/device/amazon/hdx-common/Cuber/hash.abc", "rb")
    block = f.read(32)
    ...
    pref = int(prefix)
    file = open("/home/cpasjuste/android-cm/device/amazon/hdx-common/Cuber/signature.abc","wb")
